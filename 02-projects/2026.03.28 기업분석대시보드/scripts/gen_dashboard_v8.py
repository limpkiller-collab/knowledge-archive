#!/usr/bin/env python3
"""v8: Analyst-style commentary dashboard for NVDA
- NVIDIA IR 공시 데이터 기반 교차 검증 완료 (2026.02.25 Q4 FY2026 Earnings)
- 증권사/애널리스트 리포트 분석 관점 반영
- 추정치 vs 공시 데이터 구분 표시
"""
import math
...
<div class="tc" id="t-financial">
  ...
  <div class="fin-item">
    ...
    <div class="fin-metric-row">
      ...
      <div class="fin-metric-change" style="color:var(--red)"><span style="font-size:11px;">&#9650;</span> 전년 대비 +61%</div>
    </div>
...
<div class="wm">StockLens Dashboard v8.0 | NVDA 종합분석 | 데이터: NVIDIA IR 공시 (FY2026 Q4, 2026.02.25) + 애널리스트 리포트 | 생성일: 2026.03.28<br>주요 출처: NVIDIA Newsroom, MacroTrends, FactSet Consensus | ⚠️ 투자 참고용이며 투자 권유가 아닙니다.</div>
...
# Write to file
output_path = "/sessions/exciting-gracious-pasteur/mnt/자산 대시보드 제작/02-projects/2026.03.28 기업분석대시보드/output/기업분석_종합대시보드_v8_2026.03.28.html"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(html)

print(f"v8 Dashboard generated: {output_path}")
