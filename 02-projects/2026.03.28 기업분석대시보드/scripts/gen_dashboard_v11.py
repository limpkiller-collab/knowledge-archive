#!/usr/bin/env python3
"""v11: Supanova Premium Design System 적용
- Pretendard + Geist 폰트, Vantablack Luxe 테마
- Double-bezel 글래스 카드, mesh gradient 배경
- cubic-bezier(0.16,1,0.3,1) 스프링 모션
- IntersectionObserver fadeInUp 스크롤 애니메이션
- Floating glass pill 네비게이션
- 노이즈 텍스처 오버레이
- word-break:keep-all 한국어 타이포그래피
"""
import math
...
<div class="wm">StockLens Dashboard v11.0 | NVDA 종합분석 | 데이터: NVIDIA IR 공시 (FY2026 Q4, 2026.02.25) + 애널리스트 리포트 | 생성일: 2026.03.28<br>주요 출처: NVIDIA Newsroom, MacroTrends, FactSet Consensus | ⚠️ 투자 참고용이며 투자 권유가 아닙니다.</div>
...
# Write to file
output_path = "/sessions/exciting-gracious-pasteur/mnt/자산 대시보드 제작/02-projects/2026.03.28 기업분석대시보드/output/기업분석_종합대시보드_v11_2026.03.28.html"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(html)

print(f"v11 Dashboard generated: {output_path}")
